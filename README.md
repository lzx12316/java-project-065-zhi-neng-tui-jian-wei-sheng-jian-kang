...
本项目是 **基于智能推荐的卫生健康系统**，采用主流 Java Web 技术栈开发，功能完整、结构清晰，非常适合作为毕业设计或课程设计的参考源码。

**仓库名**：`java-project-065-zhi-neng-tui-jian-wei-sheng-jian-kang`

**原始压缩包名**：`springboot065基于智能推荐的卫生健康系统`
